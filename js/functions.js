...
function areaRestritaAberta() {
    ...
    window.addEventListener("click", function (evento) {
        ...
        if (!areaContAlterada.contains(elemento) && !btnArea.contains(elemento) && !btnAreaMobile.contains(elemento)) {
...
const alterarRadio = document.getElementById("radio");
const alterarLogo = document.getElementById("radio-logo");
const alterarIconeRadio = document.getElementById("icone-radio");
...
if (window.location.pathname === '/views/contato.html') {
